...
export const files = pgTable(
  'File',
  {
    ...
    showOnProfile: boolean().default(false).notNull(),
    profileCaption: text(),
...
export const fileLikes = pgTable(
  'FileLike',
  {
    id: id(),
    createdAt: createdAt(),
  ...
  (table) => [
    primaryKey({ name: 'FileLike_pkey', columns: [table.id] }),
    index('FileLike_fileId_idx').on(table.fileId),
    uniqueIndex('FileLike_fileId_visitorId_key').on(table.fileId, table.visitorId),
  ],
);
...
export const fileComments = pgTable(
  ...
  (table) => [
    primaryKey({ name: 'FileComment_pkey', columns: [table.id] }),
    index('FileComment_fileId_idx').on(table.fileId),
  ],
);
